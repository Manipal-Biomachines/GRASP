...
def _main():
    ...
    for line in contents:
        ...
        try:
            json_contents["Index"].append(int(value))
        except:
            pass

        value = line[6:13].strip()
        try:
            json_contents["Number"].append(int(value))
        except:
            pass

        value = line[13:18].strip()
        try:
            json_contents["Name"].append(str(value))
        except:
            pass

        value = line[18:24].strip()
        try:
            json_contents["Chain"].append(str(value))
        except:
            pass

        value = line[24:36].strip()
        try:
            json_contents["InterDG"].append(str(round(float(value), 4)))
        except:
            pass

        value = line[36:48].strip()
        try:
            json_contents["InterDDG"].append(str(round(float(value), 4)))
        except:
            pass

        value = line[48:60].strip()
        try:
            json_contents["NormTerDDG"].append(str(round(float(value), 4)))
        except:
            pass

        value = line[60:72].strip()
        try:
            json_contents["IntraDG"].append(str(round(float(value), 4)))
        except:
            pass

        value = line[72:84].strip()
        try:
            json_contents["IntraDDG"].append(str(round(float(value), 4)))
        except:
            pass

        value = line[84:96].strip()
        try:
            json_contents["NormTraDDG"].append(str(round(float(value), 4)))
        except:
            pass

        value = line[96:107].strip()
        try:
            json_contents["ChainAtoms"].append(int(value))
        except:
            pass
